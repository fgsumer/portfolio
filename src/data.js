...
export const data2 = [
  ...
  },
  {
    ...
    description:
      'It is one of my React practices in which I have built the game tic-tac-toe in React, using React hooks.',
    technologyUsed: ['React'],
    link: {
      github: 'https://github.com/fgsumer/tic-tac-toe',
    },
  },
  {
    name: 'JavaScript30',
    description:
      "It's a collection of exercises to get inside JS built by following his 30 Day Vanilla JS Coding Challenge but with my own twist and tweaks of course. Live demos are on my codepen account.",
